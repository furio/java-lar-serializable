...
public class DefaultFileNames {
	...
	public static final String BORDO3_FILE = "bordo3.json";
	public static final String SELETTORI_FILE = "selettori.json";
	public static final String SELETTORI_BIN_FILE = "selettori.bin";
